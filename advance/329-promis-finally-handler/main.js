...
myPromis
  .then((success) => console.log(success)) //fullfilled
  .catch((error) => console.log( error))   //regected
  .finally(()=>{
    console.log("پرامیس انجام شد ! :)");    // finally  ==> چه ریجکت بشه چه موفق در نهایت این اجرا میشه
    //* موقعی استفاده میکنیم که بخوایم یه کد و تو هر دو قسمت ریجکت و موفقست اجرا کنیم
  })
